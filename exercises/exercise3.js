...
module.exports.botScripts = [
  ...
  {
    label: 'Question 2',
    prompt: 'What is #{answer2}?',
    handler: function (params) {
      const answer2 = params.answer2;
      if (answer2 === 'canada' || answer2 === 'Canada') {
        return (
          answer2 +
